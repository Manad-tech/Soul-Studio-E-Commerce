    ...
    <section className="flex min-h-[calc(100vh-80px)] items-center py-20 bg-[#0D0D0D]">
      <Container>
        <div className="mx-auto max-w-md rounded-[32px] border border-white/10 bg-[#111111] p-10 shadow-2xl">
          ...
          {!showOtpStep ? (
            <>
              <h1 className="text-center font-serif text-4xl text-white">Welcome Back</h1>
              <p className="mt-2 text-center text-white/60">Log in to manage your collection.</p>
              ...
              <p className="mt-8 text-center text-white/60">
                Don't have an account? <Link to="/register" className="text-[#C58A5C] hover:underline">Register</Link>
              </p>
            </>
          ) : (
